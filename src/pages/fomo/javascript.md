...
- [The building blocks of Web Workers + 5 use cases when you should use them](https://blog.sessionstack.com/how-javascript-works-the-building-blocks-of-web-workers-5-cases-when-you-should-use-them-a547c0757f6a)
...
- [Clean Code Javascript version - Software engineering principles, from Robert C. Martin's book Clean Code](https://github.com/ryanmcdermott/clean-code-javascript)
...
- [Forms of object composition - Aggregation, Concatenation, Delegation](https://medium.com/javascript-scene/the-hidden-treasures-of-object-composition-60cd89480381)
  [A guide to prototype inheritance](https://tylermcginnis.com/beginners-guide-to-javascript-prototype/)
...
- [Functional Programming for the Beginners](https://courses.knowthen.com/courses/enrolled/283395)
...
- [Tackle with IntersectionObserver API](https://alligator.io/js/intersection-observer/)
...
- [`Pika` - npm package building, re-imagined](https://www.pikapkg.com/blog/introducing-pika-pack/)
...
- [VerbalExpressions - JavaScript Regular Expressions made easy](https://github.com/VerbalExpressions/JSVerbalExpressions#readme)
